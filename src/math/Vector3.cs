...
namespace RayTracer
{
    ...
    public readonly struct Vector3
    {
        ...
        /// </summary>
        /// <returns>Length of the vector</returns>
        public double distanceBetween(Vector3 with)
        {
            return (double) Math.Sqrt(Math.Pow(X - with.X, 2) + Math.Pow(Y - with.Y,2) + Math.Pow(Z - with.Z, 2));
        }
        ...
        {
            // Write your code here...
            Vector3 line = new Vector3(X, Y, Z);
            return line / Length();
        }
        ...
        {
            // Write your code here...
            double dot = (X * with.X) + (Y * with.Y) + (Z * with.Z);
